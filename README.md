...
<div><img style="max-width:20%" src="https://0xword.com/224-thickbox_default/libro-hacking-aplicaciones-web-sql-injection.jpg" alt="Libro Hacking de Aplicaciones Web: SQL Injection. Tercera edición"/></div>
